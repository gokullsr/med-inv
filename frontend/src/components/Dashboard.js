...
const Dashboard = () => {
  ...
  return (
    <div className="dashboard">
      <h1><span style={{ WebkitTextFillColor: "initial", marginRight: "8px" }}>🏥</span> Medical Inventory Dashboard</h1>
      ...
      <div className="dashboard-section">
        <h2><span style={{ WebkitTextFillColor: "initial", marginRight: "8px" }}>📦</span> Current Inventory ({inventory.length} items)</h2>
        {inventory.length === 0 ? (
          <div style={{
            textAlign: 'center',
            padding: '3rem',
      ...
      {(lowStockAlerts.length > 0 || expiringSoon.length > 0) && (
        <div className="dashboard-section">
          <h2><span style={{ WebkitTextFillColor: "initial", marginRight: "8px" }}>⚠️</span> System Alerts</h2>
      ...
      {sales.length > 0 && (
        <div className="dashboard-section">
          <h2><span style={{ WebkitTextFillColor: "initial", marginRight: "8px" }}>💰</span> Recent Sales</h2>
          <table>
            <thead>
              <tr>
                <th>Medicine</th>
